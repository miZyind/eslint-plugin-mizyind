...
export default [
  ...
  prettier,
  {
    ...
    rules: {
      ...
      'no-await-in-loop': 'off', // Unnecessary, too strict
      ...
      'capitalized-comments': 'off', // Unnecessary, too strict
      ...
      curly: ['error', 'all'], // Override Prettier's curly rule
      'default-case': 'error',
      ...
      'multiline-comment-style': 'off', // Unnecessary, too strict
      ...
      'no-lonely-if': 'error',
      'no-loop-func': 'error',
      'no-magic-numbers': 'off', // Unnecessary, too strict
      'no-mixed-operators': 'off', // Unnecessary for Prettier
      'no-multi-assign': 'error',
      'no-multi-str': 'error',
      'no-negated-condition': 'error',
      'no-nested-ternary': 'off', // Unnecessary, too strict
      'no-new': 'error',
      'no-new-func': 'error',
      'no-new-object': 'error',
      ...
      'no-undef-init': 'error',
      'no-undefined': 'off', // Unnecessary, too strict
