...
const globals = require('globals').node;
...
module.exports = [
  ...
  ),
  {
    ...
    rules: {
      ...
      'lines-between-class-members': 'off', // @stylistic/ts/lines-between-class-members
      ...
      'padding-line-between-statements': 'off', // @stylistic/padding-line-between-statements
